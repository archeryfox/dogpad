...
const Profile = ({picSize = 14}) => {
    const {user, logout, updateUser, requestRoleChange} = useAuthStore();
                        ...
                        <div>
                            {isEditing ? (
                                ...
                                <>
                                    ...
                                    <p className="text-gray-600 mt-2"><strong>Баланс:</strong> {user.balance}₽</p>
                                    <p className="text-gray-600 mt-2"><strong>Роль:</strong> {localRole(user.role) || 'Не указана'}
                                    </p>
                                    {roleChangeStatus && (
